...
const parcours = [
  {
    ...
    included: [
      "Accès communauté, programmation et GT",
    ...
    excluded: [
      ...
      "Pack Communication",
      "Mobilisation ressources communauté"
    ],
  ...
  },
  {
    ...
    included: [
      "Accès communauté, programmation et GT",
      "2 temps forts collectifs à la CH",
      "Référent Climate House dédié",
      "Mobilisation ressources clés communauté"
    ],
    excluded: [
      "Pack Communication"
    ],
  ...
  },
  {
    ...
    included: [
      "Accès communauté, programmation et GT",
      "2 temps forts collectifs",
      "Référent Climate House dédié",
      "Pack Communication complet",
      "Mobilisation ressources clés",
      "6 rencontres transformantes (½ journée)"
    ],
    excluded: [],
  ...
  },
  {
    ...
    included: [
      ...
      "Pack Communication complet",
      "Mobilisation ressources clés",
      "Format groupe de travail collaboratif"
    ],
    excluded: [],
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Des parcours complémentaires de rencontres transformantes adaptés 
              à vos besoins et à votre niveau d'engagement
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {parcours.map((p, index) => (
              <Card
                key={p.name}
                className={`p-6 hover:shadow-strong transition-all duration-300 hover:-translate-y-2 animate-fade-in ${
                  p.highlight ? 'border-2 border-primary' : ''
                }`}
                style={{ animationDelay: `${index * 100}ms` }}
              >
                {p.highlight && (
                  <Badge className="mb-4 bg-gradient-hero">Recommandé</Badge>
                )}
                ...
                <Button 
                  className={`w-full mt-6 ${p.highlight ? 'bg-gradient-hero' : ''}`}
